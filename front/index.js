...
$(document).on("pageshow","#home",function(){
	$.ajax({
		url: "http://127.0.0.1:8080/computer/products?limit=9&ordering=-sold", 
...
$(document).on("pageshow","#productList",function(){
    ...
    $.ajax({
    	url: "http://127.0.0.1:8080/computer/products_by_category?ordering=-sold&category="+category, 
    	success: function(res){
        	console.log(res);
            ...
            if (res.next != null){
                ...
                global_next = "http://127.0.0.1:8080/computer/products_by_category?ordering=-sold&category="+category;                       
            }
            ...
            if (res.previous != null){
                ...
                global_prev = "http://127.0.0.1:8080/computer/products_by_category?ordering=-sold&category="+category;                       
            }
    ...
    $(".manufacturer").click(function(){
        ...
        var tmp = "http://127.0.0.1:8080/computer/products_by_category_manufacturer?ordering="+$(this).attr("ordering")+"&category="+category+"&manufacturer="+$(this).attr("value");

        $.ajax({
            url: "http://127.0.0.1:8080/computer/products_by_category_manufacturer?ordering="+$(this).attr("ordering")+"&category="+category+"&manufacturer="+$(this).attr("value"), 
            success: function(res){
                console.log(res);
                $("#page_no").html("1");
...
$(".ordering").click(function(){
    ...
    var tmp = "http://127.0.0.1:8080/computer/products_by_category?ordering="+$(this).attr("value")+"&category="+category;

    $.ajax({
        url: "http://127.0.0.1:8080/computer/products_by_category?ordering="+$(this).attr("value")+"&category="+category, 
        success: function(res){
            console.log(res);
            $("#page_no").html("1");
...
$(document).on("pageshow","#usercenter",function(){
    var id = 0;
    $.ajax({
        url: "http://127.0.0.1:8080/computer/user_info/", 
        headers: myheader(),
        success: function(res){
            console.log(res);
            id = res.id;
